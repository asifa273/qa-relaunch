...
public void main(String[] args) { // The main method is the entry point of the program. It is where the execution starts.
    ...
    // The same logic applies to the other numbers being checked for primality.
    System.out.println("0 is " + ((isPrime(0) ? "" : "not")) + " a prime number"); // This line checks if 0 is a prime number and prints the result
